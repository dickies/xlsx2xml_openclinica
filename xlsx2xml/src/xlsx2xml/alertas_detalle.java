...
public class alertas_detalle
{
  ...
  public static void main(String[] args)
  {
    ...
    String FormOID = "F_DETALLE_ALER_10";
    int crf_id = 14;
    int numeroSujetos = 0;
    ...
    /* Parametros aceptados por consola */
      ...
      try
      {
        ...
        for (Row row : sheet) {
          ...
          else
          {
            ...
            SubjectKey = formatCell(row.getCell(1));
            ...
            out.println("\t\t\t\t\t\t<ItemGroupData ItemGroupOID=\"IG_DETAL_DETALLES_ALERTA\" ItemGroupRepeatKey=\"" + repeatkey + "\" TransactionType=\"Insert\"" + ">");
            
            out.println("\t\t\t\t\t\t\t<ItemData ItemOID=\"I_DETAL_ID_ALERTA\" Value= \"" + row.getCell(0) + "\"/>");
            out.println("\t\t\t\t\t\t\t<ItemData ItemOID=\"I_DETAL_FECHA\" Value= \"" + fecha + "\"/>");
            out.println("\t\t\t\t\t\t\t<ItemData ItemOID=\"I_DETAL_HORA\" Value= \"" + time + "\"/>");
            out.println("\t\t\t\t\t\t\t<ItemData ItemOID=\"I_DETAL_USUARIO\" Value= \"" + row.getCell(4) + "\"/>");
            out.println("\t\t\t\t\t\t\t<ItemData ItemOID=\"I_DETAL_ESTADO\" Value= \"" + row.getCell(5) + "\"/>");
            out.println("\t\t\t\t\t\t\t<ItemData ItemOID=\"I_DETAL_COMENTARIOS\" Value= \"" + row.getCell(6) + "\"/>");
